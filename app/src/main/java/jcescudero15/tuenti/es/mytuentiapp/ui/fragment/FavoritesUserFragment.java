...
public class FavoritesUserFragment extends DaggerFragment implements FavoritesUserContract.View {

    @BindView(R.id.favorites_users_recycler_view)
    RecyclerView mRecyclerView;

    @BindView(R.id.favorites_users_empty_users)
    TextView mEmptyUsersMessage;


    @Inject
    FavoritesUserContract.Presenter mPresenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_favorites_users, container, false);
